...
#'   \item \code{numThreads}: Number of threads (CPUs) to use. Only valid if dense GRM is used, check \code{\link{defaultNumThreads}}. *(default="auto")*
#'   \item \code{stackSize}: Stack size (in bytes) to use for worker threads. For more details, check \code{\link{setThreadOptions}}. *(default="auto")*
